	...
	var Home = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'nav',
					{ className: 'navbar navbar-default', style: style, role: 'navigation' },
					React.createElement(
						'h1',
						null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var MiniMap = __webpack_require__(233);
	...
	var GoogleMap = React.createClass({
	  ...
	  componentDidMount: function componentDidMount(rootNode) {
	    ...
	    this.ref.once("value", function (snapshot) {
	      ...
	      function Legend(controlDiv, map) {
	        ...
	        // Add the text
	        controlText.innerHTML = '<b><center> Map Key </center></b><br />' + '<img src="http://maps.google.com/mapfiles/ms/micons/red-dot.png" /> Center of SF <br />' + '<img src="http://maps.google.com/mapfiles/ms/micons/yellow-dot.png" /> Tennis Club<br />' + '<img src="http://maps.google.com/mapfiles/ms/micons/green-dot.png" /> Public Tennis Court<br />' + '<img src="http://maps.google.com/mapfiles/ms/micons/blue-dot.png" /> Tennis Shop<br />' + '<img src="http://maps.google.com/mapfiles/ms/micons/orange-dot.png" /> Other Facility <br />';
	      ...
	      for (var j = 0; j < points.length; j++) {
	        (function (j) {
	          ...
	          var pinImage = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|" + getPinColor(_this.state.courts[j]), new google.maps.Size(21, 34), new google.maps.Point(0, 0), new google.maps.Point(10, 34));
	            ...
	            if (_this.state.expanded === false) {
	              ...
	              if (_this.state.courts[j].type === 'shop') {
	                _this.setState({
	                  ...
	                  mini: React.createElement(MiniMap, { xcoord: _this.state.courts[j].xcoord, ycoord: _this.state.courts[j].ycoord }),
	                  expanded: true
	                });
	          ...
	          var contentString = '<div id="content" >' + _this.state.courts[j].name + '<font color = "orange">' + '<b>' + '<br>' + '</b>' + '<br>' + '</a>' + 'lat: ' + _this.state.courts[j].xcoord + ' lng: ' + _this.state.courts[j].ycoord + '<br>' + '</font>' + '</div>';
	  ...
	  render: function render() {
	    ...
	    if (this.state.type === 'court' || this.state.type === 'other') {
	      dataShowing = React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          'h3',
	      ...
	      dataShowing = React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          ' Select a Marker on the Map to Learn More about that Tennis Facility '
	        ),
	        ' '
	      );
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'col-md-7' },
	        React.createElement('div', { ref: 'gmap', className: 'map-gic', style: style })
	      ),
	      React.createElement(
	        'div',
	        { className: 'col-md-5' },
	...
	var MiniMap = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement('div', { className: 'map-gic', ref: 'maps', style: style }),
	            React.createElement('div', { id: 'pano', style: style })
	        );
	    }
	});
